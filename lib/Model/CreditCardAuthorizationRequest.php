...
class CreditCardAuthorizationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditCardAuthorizationRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['do_capture'] = isset($data['do_capture']) ? $data['do_capture'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['do_capture'] === null) {
            $invalidProperties[] = "'do_capture' can't be null";
        }
     ...
     * Sets security_code
     *
     * @param string|null $security_code Security code for the existing credit card (CVV/CVC)
     *
     * @return $this
     */
     ...
     * Sets do_capture
     *
     * @param bool $do_capture Whether it should capture(settle) the transaction
     *
     * @return $this
     */
