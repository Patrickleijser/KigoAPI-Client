...
/**
 * BookingRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Piksel\Kigo
 ...
 * @link     http://patrickleijser.nl
 */
class BookingRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingRequest';
    ...
    protected static $openAPITypes = [
        'statement' => '\Piksel\Kigo\Model\StatementRequest',
        'external_id' => 'string',
        'property_id' => 'int',
        'unit_id' => 'int',
     ...
     * Gets statement
     *
     * @return \Piksel\Kigo\Model\StatementRequest|null
     */
     ...
     * Sets statement
     *
     * @param \Piksel\Kigo\Model\StatementRequest|null $statement statement
     *
     * @return $this
     */
    ...
    public function setPropertyId($property_id)
    {
        ...
        if (($property_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $property_id when calling BookingRequest., must be smaller than or equal to 2147483647.');
        }
        if (($property_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $property_id when calling BookingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCheckInTimeMinutesFromMidnight($check_in_time_minutes_from_midnight)
    {
        ...
        if (!is_null($check_in_time_minutes_from_midnight) && ($check_in_time_minutes_from_midnight > 1439)) {
            throw new \InvalidArgumentException('invalid value for $check_in_time_minutes_from_midnight when calling BookingRequest., must be smaller than or equal to 1439.');
        }
        if (!is_null($check_in_time_minutes_from_midnight) && ($check_in_time_minutes_from_midnight < 0)) {
            throw new \InvalidArgumentException('invalid value for $check_in_time_minutes_from_midnight when calling BookingRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCheckOutTimeMinutesFromMidnight($check_out_time_minutes_from_midnight)
    {
        ...
        if (!is_null($check_out_time_minutes_from_midnight) && ($check_out_time_minutes_from_midnight > 1439)) {
            throw new \InvalidArgumentException('invalid value for $check_out_time_minutes_from_midnight when calling BookingRequest., must be smaller than or equal to 1439.');
        }
        if (!is_null($check_out_time_minutes_from_midnight) && ($check_out_time_minutes_from_midnight < 0)) {
            throw new \InvalidArgumentException('invalid value for $check_out_time_minutes_from_midnight when calling BookingRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setNumAdults($num_adults)
    {
        ...
        if (($num_adults > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $num_adults when calling BookingRequest., must be smaller than or equal to 2147483647.');
        }
        if (($num_adults < 1)) {
            throw new \InvalidArgumentException('invalid value for $num_adults when calling BookingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNumChildren($num_children)
    {
        ...
        if (($num_children > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $num_children when calling BookingRequest., must be smaller than or equal to 2147483647.');
        }
        if (($num_children < 0)) {
            throw new \InvalidArgumentException('invalid value for $num_children when calling BookingRequest., must be bigger than or equal to 0.');
        }
