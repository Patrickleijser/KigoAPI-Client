...
/**
 * PropertyDescriptions Class Doc Comment
 *
 * @category Class
 * @package  Piksel\Kigo
 * @author   Patrick Leijser
 * @link     http://patrickleijser.nl
 */
class PropertyDescriptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PropertyDescriptions';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['check_in_instructions'] === null) {
            $invalidProperties[] = "'check_in_instructions' can't be null";
        }
     ...
     *
     * @param string $check_in_instructions check_in_instructions
     *
     * @return $this
     */
