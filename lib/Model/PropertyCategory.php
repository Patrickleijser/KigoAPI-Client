...
/**
 * PropertyCategory Class Doc Comment
 *
 * @category Class
 * @package  Piksel\Kigo
 * @author   Patrick Leijser
 * @link     http://patrickleijser.nl
 */
class PropertyCategory implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PropertyCategory';
    ...
    protected static $setters = [
        'resource_string' => 'setResourceString',
        'locale' => 'setLocale',
    ...
    {
        $this->container['resource_string'] = isset($data['resource_string']) ? $data['resource_string'] : null;
    ...
    /**
     * Gets resource_string
     *
     * @return string|null
     */
    public function getResourceString()
    {
        return $this->container['resource_string'];
    }

    /**
     * Sets resource_string
     *
     * @param string|null $resource_string resource_string
     *
     * @return $this
     */
    public function setResourceString($resource_string)
    {
        $this->container['resource_string'] = $resource_string;
     ...
     *
     * @param int|null $property_category_id property_category_id
     *
     * @return $this
     */
