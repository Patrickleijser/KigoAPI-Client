...
/**
 * ImageLocalized Class Doc Comment
 *
 * @category Class
 * @package  Piksel\Kigo
 * @author   Patrick Leijser
 * @link     http://patrickleijser.nl
 */
class ImageLocalized implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageLocalized';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['url_med'] = isset($data['url_med']) ? $data['url_med'] : null;
        $this->container['url_thumb'] = isset($data['url_thumb']) ? $data['url_thumb'] : null;
    ...
    {
        return $this->container['url_med'];
    }

    /**
     * Sets url_med
     *
     * @param string|null $url_med Read-only field
     *
     * @return $this
     */
    public function setUrlMed($url_med)
    {
        $this->container['url_med'] = $url_med;
    ...
    {
        return $this->container['url_thumb'];
    }

    /**
     * Sets url_thumb
     *
     * @param string|null $url_thumb Read-only field
     *
     * @return $this
     */
    public function setUrlThumb($url_thumb)
    {
        $this->container['url_thumb'] = $url_thumb;
